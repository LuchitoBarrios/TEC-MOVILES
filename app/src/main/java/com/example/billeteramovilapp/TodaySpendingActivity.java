...
public class TodaySpendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Gastos de Hoy");
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()){
                    ...
                    totalAmountSpentOn.setText("Total de Gastos del día de hoy: S/."+totalAmount);
                }
            }
    ...
    private void addItemSpentOn() {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Item.equals("Seleccionar Item")){
                    Toast.makeText(TodaySpendingActivity.this,"Seleccionar un Item válido",Toast.LENGTH_SHORT).show();
                }
                    ...
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(TodaySpendingActivity.this,"" +
